    ...
    <>
      <main className="h-[calc(100%-64px)] pt-8 pr-14 pl-14 relative">
        <div className="p-4 text-center">
          Nesta seção, apresento o desenvolvimento técnico e criativo dos jogos que produzi.
        </div>
      ...
      <>
        {open && (
          <div className="fixed top-[0px] bottom-0 left-0 right-0  z-[900] bg-opacity-40 backdrop-blur-2xl">
            <div
              className="absolute right-9 text-2xl top-2.5 text-amber-50 cursor-pointer"
